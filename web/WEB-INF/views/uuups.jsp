...
<div class="wrapper">
	...
	<div class="middle">
		...
		<jsp:include page="./jspf/leftAside.jsp" />

		<jsp:include page="./jspf/rightAside.jsp" />
		
		<jsp:include page = "./jspf/banerCentral.jsp" />
		...
		<div class="containerIn">
            ...
            <section>
                <article>
                    <h1>Ой, ви трішки не попали, пройдіть по навігації чи скористайтесь пошуком, і все буду чудово!</h1>
				</article>
			</section>	
